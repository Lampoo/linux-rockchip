...
#define vl6180_dbgmsg(str, args...) printk(KERN_DEBUG "%s: " str, __func__, ##args)
...
#define VL6180_VDD_MIN      2500000//2600000
...
struct stmvl6180_module_fn_t {
	...
	int (*power_up)(void *object, unsigned int *preset_flag);
	int (*power_down)(void *object);
};
