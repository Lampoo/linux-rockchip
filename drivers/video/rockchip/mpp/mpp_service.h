...
struct mpp_service {
	...
	struct device *dev;
	struct rockchip_mpp_dev *current_dev;
...
void mpp_srv_pending_lock(struct mpp_service *pservice, struct mpp_ctx *ctx);
...
void mpp_srv_err_hdl_lock(struct mpp_service *pservice);
